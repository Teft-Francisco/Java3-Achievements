...
public class User {
    ...
    public User() {
        this(0,"John","Doe","john@example.com","Passw0rd".toCharArray(), "none");
    }
    public User(int id, String first_name, String last_name, String email,char[] password, String roles) {
        setId(id);
    ...
    public User(int id, String first_name, String last_name, String email, String roles) {
        setId(id);
        setFirst_name(first_name);
        setLast_name(last_name);
        setEmail(email);
